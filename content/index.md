---
seo:
  title: Evaluate Job Offers Before You Accept Them | Applicants.io
  description: Research companies before you interview. Applicants.io aggregates public reports to help candidates identify risk patterns in job opportunities.
---
...
#title
Evaluate Job Offers [Before You Accept Them]{.text-primary}.

#description
Research companies before you interview. Applicants.io helps candidates identify risk patterns in job opportunities using publicly available information from forums, reviews, and discussions.
...
::u-page-section{class="dark:bg-gradient-to-b from-neutral-950 to-neutral-900"}
  ...
  links:
    ...
    - label: Learn How We Score
      to: '/methodology/overview'
      variant: subtle
      icon: i-lucide-bar-chart-3
  title: Ready to research a company?
  description: Search our database of company intelligence pages, read guides about common recruiting patterns, and understand how we evaluate risk.
